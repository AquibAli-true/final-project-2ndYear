const NutritionCardC = () => {
  return (
    <div className="w-full max-w-7xl mx-auto p-4">
      <div className="bg-[#44D07B] rounded-[2rem] p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 text-white">
